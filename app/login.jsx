            ...
            {mode === 'mobile' ? (
              <div className="fade-in">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  {[['laimay', 'Thợ lái máy', 'excavator'], ['laixe', 'Lái xe vận chuyển', 'truck'], ['vattu', 'Cán bộ vật tư / Thủ kho', 'package'], ['kythuat', 'Cán bộ kỹ thuật', 'tasks'], ['chuhuy', 'Chỉ huy trưởng', 'shield-check'], ['congnhan', 'Công nhân', 'users']].map(([k, l, ic]) => (
