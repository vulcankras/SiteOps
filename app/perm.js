...
(function () {
  const PERM = {
    ...
    nav: {
      ...
      exec: ['dashboard', 'cong-truong', 'cong-viec', 'kho-nhap', 'kho-xuat', 'kho-thiet-bi', 'kho-vat-tu', 'kho-ton'],
      kt: ['dashboard', 'cong-truong', 'cong-viec', 'kho-thiet-bi', 'kho-ton'],
      wh: ['dashboard', 'cong-truong', 'kho-dashboard', 'kho-nhap', 'kho-xuat', 'kho-kiem', 'kho-thiet-bi', 'kho-vat-tu', 'kho-sua-chua', 'kho-ton', 'kho-list', 'kho-bao-cao', 'kho-canh-bao', 'doi-tac', 'khach-hang', 'danh-muc'],
      acc: ['dashboard', 'cong-truong', 'kho-ton', 'hrm-luong', 'bao-cao', 'doi-tac', 'khach-hang', 'danh-muc'],
    },
    ...
    tabs: {
      ...
      exec: ['tong-quan', 'cong-viec', 'tien-do', 'khu-vuc', 'nhat-ky', 'vat-lieu-do', 'thiet-bi', 'ton-kho', 'nhan-su', 'ho-so'],
      kt: ['tong-quan', 'cong-viec', 'tien-do', 'khu-vuc', 'nhat-ky', 'vat-lieu-do', 'nhan-su', 'ho-so'],
